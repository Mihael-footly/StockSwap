...
export const metadata:Metadata={title:{default:'StockSwap — Swap stock exposure.',template:'%s | StockSwap'},description:'Move from one supported stock-linked asset to another through the best available route. Verified assets. Transparent routing.',icons:{icon:'/icon.png',apple:'/apple-icon.png'}};
